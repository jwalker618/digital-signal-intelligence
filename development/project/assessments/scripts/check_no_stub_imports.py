...
# Directories that may legitimately import stubs. V6/E10 finalized —
# stubs now live under tests/fixtures/stub_extractors/. The old
# signal_architecture/signals/extractors/stubs/ location is gone, and
# the pre-V6 phase_N_signals.py allow-list is cleared (every inference
# module now returns neutral stand-ins without stub imports).
ALLOWED_PREFIXES = (
    "tests/",
