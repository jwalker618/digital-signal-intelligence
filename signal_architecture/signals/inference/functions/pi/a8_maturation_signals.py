...
async def pi_a8_01(entity_id: str, context: Any) -> SignalResult:
...
async def pi_a8_02(entity_id: str, context: Any) -> SignalResult:
...
async def pi_a8_03(entity_id: str, context: Any) -> SignalResult:
...
async def pi_a8_04(entity_id: str, context: Any) -> SignalResult:
...
async def pi_a8_05(entity_id: str, context: Any) -> SignalResult:
