...
|----------|-------------|-------------|-----------------|
| `network_authority` | 15% | 0% | 0% |
| `regulatory_standing` | 25% | 0% | 0% |
| `firm_stability` | 15% | 0% | 0% |
| `practice_quality` | 15% | 0% | 0% |
| `technical_infrastructure` | 10% | 0% | 0% |
| `corporate_footprint` | 10% | 0% | 0% |
| `litigation_history` | 10% | 0% | 0% |
