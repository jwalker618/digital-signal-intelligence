...
All return neutral SignalResult(score=500). Real bodies wire in once
...
async def casualty_a3_gl_01(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_gl_02(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_gl_03(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_gl_04(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_auto_01(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_auto_02(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_auto_03(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_auto_04(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_auto_05(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_auto_06(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_env_01(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_env_02(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_env_03(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_env_04(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_umb_01(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_umb_02(entity_id: str, context: Any) -> SignalResult:
...
async def casualty_a3_umb_03(entity_id: str, context: Any) -> SignalResult:
