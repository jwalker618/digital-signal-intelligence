...
## Model: `env_industrial`
*Chemical / industrial manufacturing with TRI reporting*
...
| `env_liab_primary_derived_01` | INFERRED_PROXY | 0.01 | 0.01 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_02` | INFERRED_PROXY | 0.01 | 0.00 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_03` | INFERRED_PROXY | 0.01 | 0.00 / 0.01 | 0.00 | + |
| `env_liab_primary_derived_04` | INFERRED_PROXY | 0.01 | 0.01 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_05` | INFERRED_PROXY | 0.01 | 0.00 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_06` | INFERRED_PROXY | 0.01 | 0.00 / 0.01 | 0.00 | + |
| `env_liab_primary_derived_07` | INFERRED_PROXY | 0.01 | 0.01 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_08` | INFERRED_PROXY | 0.01 | 0.00 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_09` | INFERRED_PROXY | 0.01 | 0.00 / 0.01 | 0.00 | + |
| `env_liab_primary_derived_10` | INFERRED_PROXY | 0.01 | 0.01 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_11` | INFERRED_PROXY | 0.01 | 0.00 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_12` | INFERRED_PROXY | 0.01 | 0.00 / 0.01 | 0.00 | + |
| `env_liab_primary_derived_13` | INFERRED_PROXY | 0.01 | 0.01 / 0.00 | 0.00 | + |
| `env_liab_primary_derived_14` | INFERRED_PROXY | 0.01 | 0.00 / 0.00 | 0.00 | + |
...
## Model: `env_waste_mgmt`
*Waste management / landfills / treatment*

### Routing Protocol (Multiplexer)
- `facility_type == waste_mgmt`
...
## Model: `env_real_estate`
*Real estate / brownfield redevelopment*

### Routing Protocol (Multiplexer)
- `facility_type == real_estate`
...
## Model: `env_energy_midstream_xwalk`
*Pipeline operators*

### Routing Protocol (Multiplexer)
- `facility_type == energy_midstream`
...
## Model: `env_sme`
*Small facilities (retail / hospitality NAICS)*

### Routing Protocol (Multiplexer)
- `naics_2digit in ['44', '45', '72']`
