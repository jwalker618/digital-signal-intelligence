...
SignalResult with score=50.0 and proxy-tier-scaled confidence. Real
...
def wc_004(entity_id: str, context: Any) -> SignalResult:
...
def wc_028(entity_id: str, context: Any) -> SignalResult:
