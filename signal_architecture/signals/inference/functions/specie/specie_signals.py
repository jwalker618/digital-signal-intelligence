"""Specie Inference Functions (V6/B11 depth-first build)."""
...
async def sp_029(entity_id: str, context: Any) -> SignalResult:
...
async def sp_032(entity_id: str, context: Any) -> SignalResult:
...
async def sp_033(entity_id: str, context: Any) -> SignalResult:
    """website_quality"""
