...
async def property_a2_01(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_02(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_03(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_04(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_05(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_06(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_07(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_08(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_09(entity_id: str, context: Any) -> SignalResult:
...
async def property_a2_10(entity_id: str, context: Any) -> SignalResult:
