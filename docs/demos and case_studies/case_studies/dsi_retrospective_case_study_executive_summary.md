...
## Case Studies: Retrospective Validation - Executive Summary
...
>
> **DSI does not claim to predict all breaches. It claims to systematically identify elevated risk based on observable organisational behavior. This validation supports that claim.**
