...
|-|-|-|
| 1 | Foundation | |
| 2 | Reusable Categorizer Types | |
| 3 | Coverage Implementations | |
| 4 | Config-Driven Model | |
| 5 | Scoring Engine | |
| 6 | Discovery Integration | |
| 7 | Traditional Modifiers | |
| 8 | Analytics Engine | |
| 9 | Test Profiles | |
| 10 | Multi-Coverage | |
| 11 | Production API | |
...
| 13 | LLM Builder | |
| 14 | Examples | |
| 15 | Production Extractors | |
| 16 | Loss Correlation | |
| 17 | Exposure Shadow Layer | |
| 18 | Architecture Restructuring | |
| 19 | DSI Demo Production Build | |
| 20 | Config Architecture & Org Graph | |
| 21 | Loss Correlation Implementation | |
| 22 | Exposure Shadow Implementation | |
| 23 | Organisational Graph Runtime | |

## Version 2: Restructure (R1-R11)

| Phase | Name | Complete |
|-|-|-|
| R1 | Master Configuration Layout | |
| R2 | Signal Architecture Alignment | |
| R3 | Coverage Configuration Rebuilds | |
| R4 | Infrastructure Builder Revision | |
| R5 | Infrastructure Verification | |
| R6 | Layer Implementations | |
| R7 | Model Configuration Validation | |
| R8 | Organisational Graph Runtime | |
| R9 | Performance Enhancement (Rust) | |
| R10 | Documentation & Cleanup | |
| R11 | Testing | |
...
| Phase | Name | Complete |
|-|-|-|
| P1 | Fix Broken Fundamentals | |
| P2 | Database Persistence | |
| P3 | Production Extractor Wiring | |
| P4 | End-to-End Integration Testing | |
| P5 | Observability | |
| P6 | Deployment Pipeline | |
...
| Phase | Name | Complete |
|-|-|-|
| V3-1 | Test Suite Recovery | |
| V3-2 | Continuous Monitoring Pipeline | |
| V3-3 | LLM Integration for Builder | |
| V3-4 | Production Signal Extractors | |
| V3-5 | Simulation Engine Foundation | |
| V3-6 | Release v1.0.0 | |
...
| Phase | Name | Complete |
|-|-|-|
| V4 | Multi-Configuration Multiplexer | |
| V4.1 | Metadata-Driven Routing Constraints | |
| V5 | Advanced Pricing (Anchors & Towers) | |
| V6 | Schema Consolidation & Builder Modernization | |
