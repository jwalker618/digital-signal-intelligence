...
async def do_a4_01(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_02(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_03(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_04(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_05(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_06(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_07(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_08(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_09(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_10(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_11(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_12(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_13(entity_id: str, context: Any) -> SignalResult:
...
async def do_a4_14(entity_id: str, context: Any) -> SignalResult:
