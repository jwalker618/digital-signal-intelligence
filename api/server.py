...
cyber_signals_model = cyber_ns.model('CyberSecuritySignals', {
...
cyber_profile_model = cyber_ns.model('CyberCompanyProfile', {
...
energy_signals_model = energy_ns.model('DigitalSignals', {
...
energy_profile_model = energy_ns.model('EnergyCompanyProfile', {
    'company_name': fields.String(required=True),
    'country': fields.String(required=True),
...
fi_signals_model = fi_ns.model('FinancialInstitutionSignals', {
...
fi_profile_model = fi_ns.model('FinancialInstitutionProfile', {
...
class CyberQuote(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            coverage_type = CyberCoverageType[coverage_str] if coverage_str in CyberCoverageType.__members__ else CyberCoverageType.COMPREHENSIVE
            ...
            logger.info(f"Cyber quote generated: {result.company_name} - ${result.annual_premium:,.2f}")
            return response, 200
...
class EnergyQuote(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            logger.info(f"Energy quote generated: {result.company_name} - ${result.annual_premium:,.2f}")
            return response, 200
...
class FIQuote(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            coverage_type = FICoverageType[coverage_str] if coverage_str in FICoverageType.__members__ else FICoverageType.DNO
            ...
            logger.info(f"FI quote generated: {result.institution_name} - ${result.annual_premium:,.2f}")
            return response, 200
