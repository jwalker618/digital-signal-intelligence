  ...
  if (isFetchingTerms) {
    return (
      <div className="flex flex-col items-center justify-center py-20 opacity-50 space-y-4">
        ...
        <p className="text-sm tracking-widest uppercase">Loading Commercial Terms...</p>
      </div>
    );
  }
  ...
  if (!commercialTerms) {
    return (
      <div className="flex flex-col items-center justify-center py-20 opacity-50 space-y-4">
        ...
        <p className="text-sm tracking-widest uppercase">No commercial terms available for this submission</p>
      </div>
    );
  }
