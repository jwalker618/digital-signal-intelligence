...
def vulnerable_signals():
    ...
    return CyberSecuritySignals(
        ...
        open_ports_score=45, outdated_software=38, known_vulnerabilities=35,  # CRITICAL
        exposed_databases=40, leaked_credentials=30, breached_history=35,     # CRITICAL
        security_certifications=55, privacy_policy_quality=60, incident_response_plan=45,
        bug_bounty_program=0, security_team_visibility=50, security_blog_activity=30,
        vendor_security_standards=48, supply_chain_transparency=42, cloud_provider_quality=65,
        third_party_integrations=50, data_processor_agreements=45,
        patch_discipline=35, security_investment=40, employee_training=45,
...
class TestDataSensitivityPricing:
    ...
    def test_pii_volume_impact(self):
        ...
        base_company = CyberCompanyProfile(
            company_name="Test", industry=IndustryVertical.OTHER,
            country="US", annual_revenue=10_000_000, employees=100,
            size_category=CompanySize.SMALL,
            pii_volume="low"
        )
    ...
    def test_phi_handler_premium(self):
        ...
        company = CyberCompanyProfile(
            company_name="Test", industry=IndustryVertical.HEALTHCARE,
            country="US", annual_revenue=10_000_000, employees=100,
            size_category=CompanySize.SMALL,
            phi_handler=False
        )
...
class TestBreachProbability:
    ...
    def test_industry_affects_probability(self):
        ...
        manufacturing_prob = model.estimate_breach_probability(600, IndustryVertical.MANUFACTURING, 0)
...
class TestEdgeCases:
    ...
    def test_zero_signals_handling(self):
        ...
        assert "Manual Review" in result.recommendation or "Insufficient Data" in result.recommendation
    ...
    def test_extreme_revenue_handling(self):
        ...
        tiny = CyberCompanyProfile(
            company_name="Tiny", industry=IndustryVertical.OTHER,
            country="US", annual_revenue=1_000_000, employees=5,
            size_category=CompanySize.SMALL,
        ...
        giant = CyberCompanyProfile(
            company_name="Giant", industry=IndustryVertical.TECHNOLOGY,
            country="US", annual_revenue=100_000_000_000, employees=200000,
