"""Captive Inference Functions (V6/B12 depth-first build)."""
...
async def ca_006(entity_id: str, context: Any) -> SignalResult:
...
async def ca_011(entity_id: str, context: Any) -> SignalResult:
