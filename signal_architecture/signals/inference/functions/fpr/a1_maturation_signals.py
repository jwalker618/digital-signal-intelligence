...
All return neutral SignalResult(score=500). Real bodies wire in with
...
async def fpr_a1_01(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_02(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_03(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_04(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_05(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_06(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_07(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_08(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_09(entity_id: str, context: Any) -> SignalResult:
...
async def fpr_a1_10(entity_id: str, context: Any) -> SignalResult:
