...
from website_discovery.dsi_website_discovery import (  # noqa: E402
...
def example_single_company():
    ...
    if result.best_match:
        ...
        print(
            f"  Corporate Indicators Found: {len(result.best_match.corporate_indicators)}"
        )
...
def example_with_domain_hint():
    ...
    print(
        f'  Hint prioritized: {result_with_hint.best_match.discovery_method.value == "manual"}'
    )
